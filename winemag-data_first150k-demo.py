...
#输出标称属性可能取值的频数列表
def nafrequ():
    print('country可能取值的频数:')
    print(frequ('country'))
    print('province可能取值的频数:')
    print(frequ('province'))
    print('variety可能取值的频数:')
    print(frequ('variety'))
...
#    print(df[u'points'].corr(df[u'price']))
#    print(df_shuzhi.corr())

#    print(ttest_rel(aa,bb))
#    corrsp(df_shuzhi)#输出相关性
#    corfill(df_shuzhi,'price','points')#根据相关性填充
